...
describe('RegisterForm', () => {
    ...
    it('should show firstname error when firstname is empty after blur', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText('Firstname is required')
            ).toBeInTheDocument();
        });
    });
    ...
    it('should show lastname error when lastname is empty after blur', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText('Lastname is required')
            ).toBeInTheDocument();
        });
    });
    ...
    it('should not show errors before fields are touched', () => {
        ...
        expect(
            screen.queryByText('Firstname is required')
        ).not.toBeInTheDocument();
        expect(
            screen.queryByText('Lastname is required')
        ).not.toBeInTheDocument();
