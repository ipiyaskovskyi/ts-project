import type { KanbanTask, UserProfile, TimeSlot, EfficiencyItem, CompletedTaskData } from '../types';
...
export const mockKanbanTasks: KanbanTask[] = [
  {
    ...
    subtasks: [
      { id: 'sub-1', label: 'A', title: 'Incididunt ut labore et dolore', completed: false },
  ...
  },
  {
    ...
    subtasks: [
      { id: 'sub-3', label: 'C', title: 'Incididunt ut labore et dolore', completed: false },
    ],
    comments: 1,
    files: 0,
    stars: 5,
  ...
  },
  {
    ...
    subtasks: [
      { id: 'sub-4', label: '', title: 'Adipiscing elit sed do eiusmod', completed: false },
      { id: 'sub-5', label: '', title: 'Et dolore magna aliqua', completed: false },
      { id: 'sub-6', label: '', title: 'Excepteur sint occaecat cupidatat', completed: false },
    ],
    comments: 0,
    files: 0,
    stars: 0,
  ...
  },
  {
    ...
    subtasks: [
      { id: 'sub-7', label: 'A', title: 'Incididunt ut labore et...', completed: true },
      { id: 'sub-8', label: 'B', title: 'Magna aliqua enim...', completed: true },
      { id: 'sub-9', label: 'C', title: 'Incididunt ut labore et...', completed: true },
    ],
    comments: 0,
    files: 0,
    stars: 0,
